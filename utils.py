...
#	print ("hallo!")
    ...
    if not window in ['flat', 'hanning', 'hamming', 'bartlett', 'blackman']:
        raise ValueError("Window is on of 'flat', 'hanning', 'hamming', 'bartlett', 'blockman'")
...
def loadpickledsn(snname, printsn=False):
    ...
    if printsn:
        sn.printsn(template=True,printlc=False,
                   photometry=True,color=False, extended=True)
    return sn
